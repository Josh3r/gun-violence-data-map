...
var scratchNorthWest = new _math.Vector3();
var scratchSouthEast = new _math.Vector3();
...
function createBoundingVolume(boundingVolumeHeader, transform, result) {
  ...
  if (boundingVolumeHeader.region) {
    ...
    var northWest = _geospatial.Ellipsoid.WGS84.cartographicToCartesian([(0, _math.degrees)(west), (0, _math.degrees)(north), minHeight], scratchNorthWest);

    var southEast = _geospatial.Ellipsoid.WGS84.cartographicToCartesian([(0, _math.degrees)(east), (0, _math.degrees)(south), maxHeight], scratchSouthEast);

    var centerInCartesian = new _math.Vector3().addVectors(northWest, southEast).multiplyScalar(0.5);
    var radius = new _math.Vector3().subVectors(northWest, southEast).len() / 2.0;
...
function createBox(box, transform, result) {
  ...
  var halfAxes = new _math.Matrix3([xAxis[0], xAxis[1], xAxis[2], yAxis[0], yAxis[1], yAxis[2], zAxis[0], zAxis[1], zAxis[2]]);
