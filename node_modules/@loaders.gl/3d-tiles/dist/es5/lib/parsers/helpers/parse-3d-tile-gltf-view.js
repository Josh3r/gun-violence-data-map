...
exports.extractGLTFSync = extractGLTFSync;
...
function extractGLTFSync(tile, gltfFormat, options, context) {
  extractGLTFBufferOrURL(tile, gltfFormat, options);

  if (options.loadGLTF) {
    if (tile.gltfArrayBuffer) {
      var parseSync = context.parseSync;
      tile.gltf = parseSync(tile.gltfArrayBuffer, _gltf.GLTFLoader, options, context);
      delete tile.gltfArrayBuffer;
      delete tile.gltfByteOffset;
      delete tile.gltfByteLength;
