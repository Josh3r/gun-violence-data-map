  ...
  (0, _createClass2["default"])(Tile3DLayer, [{
    ...
    value: function initializeState() {
      if ('onTileLoadFail' in this.props) {
        _core.log.removed('onTileLoadFail', 'onTileError')();
      }
    ...
    key: "_loadTileset",
    value: function () {
      var _loadTileset2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(tilesetUrl, fetchOptions, ionMetadata) {
        var _this = this;
      ...
      function _loadTileset(_x, _x2, _x3) {
    ...
    value: function () {
      var _loadTilesetFromIon2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee2(ionAccessToken, ionAssetId) {
      ...
      function _loadTilesetFromIon(_x4, _x5) {
