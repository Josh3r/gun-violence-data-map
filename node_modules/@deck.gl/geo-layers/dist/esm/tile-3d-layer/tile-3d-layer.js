...
var Tile3DLayer = function (_CompositeLayer) {
  ...
  _createClass(Tile3DLayer, [{
    ...
    key: "_loadTileset",
    value: function () {
      var _loadTileset2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(tilesetUrl, fetchOptions, ionMetadata) {
        var _this = this;
    ...
    value: function () {
      var _loadTilesetFromIon2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(ionAccessToken, ionAssetId) {
