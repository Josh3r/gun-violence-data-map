...
var Tesselator = function () {
  ...
  (0, _createClass2["default"])(Tesselator, [{
    ...
    value: function updateGeometry(opts) {
      ...
      if (geometryBuffer) {
        (0, _assert["default"])(ArrayBuffer.isView(geometryBuffer.value || geometryBuffer) && data.startIndices, 'invalid geometries');
    ...
    value: function getGeometryFromBuffer(geometryBuffer) {
      return (0, _iterableUtils.getAccessorFromBuffer)(geometryBuffer.value || geometryBuffer, {
    ...
    value: function _rebuildGeometry(dataRange) {
      ...
      var geometryBuffer = this.geometryBuffer;
      ...
      if (this.normalize || !geometryBuffer) {
        ...
        var bufferStride = geometryBuffer.stride / bufferValue.BYTES_PER_ELEMENT || this.positionSize;
