...
var _webMercator = _interopRequireWildcard(require("@math.gl/web-mercator"));
...
var MapState = function (_ViewState) {
  ...
  (0, _createClass2["default"])(MapState, [{
    ...
    value: function zoom(_ref7) {
      ...
      var zoomedViewport = new _webMercator["default"](Object.assign({}, this._viewportProps, {
        zoom: zoom
      }));
    ...
    value: function _unproject(pos) {
      var viewport = new _webMercator["default"](this._viewportProps);
