...
function calculateMatrixAndOffset(_ref) {
  ...
  if (coordinateSystem === _constants.COORDINATE_SYSTEM.LNGLAT) {
    if (projectionMode === _constants.PROJECTION_MODE.WEB_MERCATOR) {
      offsetMode = false;
    } else {
      shaderCoordinateOrigin = [Math.fround(viewport.longitude), Math.fround(viewport.latitude), 0];
    }
  } else if (projectionMode === _constants.PROJECTION_MODE.IDENTITY) {
...
function getUniformsFromViewport() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      coordinateSystem = _ref2$coordinateSyste === void 0 ? _constants.COORDINATE_SYSTEM.DEFAULT : _ref2$coordinateSyste,
