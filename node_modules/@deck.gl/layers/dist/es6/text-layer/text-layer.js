...
export default class TextLayer extends CompositeLayer {
  ...
  updateState({
    ...
    const styleChanged = props.lineHeight !== oldProps.lineHeight || props.wordBreak !== oldProps.wordBreak || props.maxWidth !== oldProps.maxWidth;
    const textChanged = fontChanged || styleChanged || changeFlags.dataChanged || changeFlags.updateTriggersChanged && (changeFlags.updateTriggersChanged.all || changeFlags.updateTriggersChanged.getText);
